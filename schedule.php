...
*/
	...
	function ses_admin_actions() {
		...
		add_menu_page("Event Schedule", "Event Schedule", "read", "SimpleEventSchedule", "ses_list",$icon_path."/Calendar.png");
		add_submenu_page("SimpleEventSchedule", "Add new event", "Add New", "read", "SimpleEventScheduleAddNew", "ses_add_new");
	}
